...
<title>Veuillez remplir le formulaire ci-dessous</title>
...
<div  id="seif6744" ></div>
    ...
    <div class="row">
        <div id="xx28" class="col-sm-12"  >
    <center><span  class="gag"> <b>Félicitation</b></span></center>

 </br> 
     <center><span  class="gag"> <b>Veuillez remplir le formulaire ci-dessous {{$res_nameprod}}
<img  src="../../images/product_images/{{$res_path_file}}" id="imgx" class="img-responsive" alt="" >
                ...
                <?php
echo Form::open(array('action' => 'ProspectController@AjouterProspect_user_succes', 'method' => 'get'))
?>



                    <div id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"></label>
                      <input type="text" class="form-control" id="nomprenom" name="nomprenom" placeholder="Entrer votre nom et prénom" required>
                    </div>

                    <div id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"></label>
                      <input type="text" class="form-control" id="email" name="email" placeholder="Entrer votre e-mail" required>
                    </div>

                    <div id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"></label>
                      <input type="date" class="form-control" id="date" name="date" placeholder="Entrer votre date" required>
                    </div>
                    <div  id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"></label>
                      <input type="text" class="form-control" id="pays" name="pays" placeholder="Entrer votre pays" required>
                    </div>
                    ...
                    <div id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"></label>
                      <input type="text" class="form-control" id="codepostal" name="codepostal" placeholder="Entrer votre code postal" required>
                    </div>
                    <div id="s33" class="form-group">
                      <label for="exampleInputEmail1" id="lb55"> </label>
                      <input type="text" class="form-control" id="nume" name="nume" placeholder="Entrer votre numéro" required>
                    </div>
                      <input type="hidden" name="xxnxx" value="{{$id_prodx}}" >
