...
<title>Gagnez  {{$name}} | GoldenMarket</title>
...
<div  class="container" >
    <div class="row">
        <div id="xx1" class="col-sm-12" id="s5" >
    <center><span  class="gag"> <b>Gagnez  {{$name}}</b></span></center>

              <div class="container">
                 <div class="row">
                      <div class="col-sm-12 col-md-6"  >    </br>
                        <div class="col-md-12" id="s4" style="background:#e6e6e6">

                               <b> <center><span class="nomprod"> Obtenez votre code facilement par téléphone au </span></center></b>
                                <center><span id="num"><b> {{$num}} <b></span></center></br>

                                <span class="cout"> 1,35€/appel puis 0,34€/min</span>
                   </br></div>
                   </br>
                      ...
                      <div id="xx" class="ss">
                          ...
                          <div id="starwork" class="col-sm-12 col-md-2"  >
                            <img href="../Produit/{{$id_prod }}" 
                                  src="../images/product_images/{{$path_file}}" 
                                  id="imgx" 
               ...
               <div class="row">
                 <div class="col-sm-12 "  >  
                      <div class="col-md-6"  id="sbmt" style="background:#e6e6e6;">
                                        <?php
                                          echo Form::open(array('action' => 'TelopController@verify', 'method' => 'post'))
                                          ?>


                                                                          <center><span class="nomprod" >Saisissez votre code obtenue ici et validez </span></center></br>
                                                                          <center><input type='text' name="code" placeholder="Enter votre Code"/>
                                                                          <input class="{{ $id_prod }}" name="ProdID" type="hidden" value="{{ $id_prod }}">
                                          <input type="hidden" name="_token" value="{!! csrf_token() !!}">

                                                                          <input type='submit'  class="btn btn-primary"value="Valider le code" required/></center> </br>
                                          {!! Form::close() !!}

                      </div>
                      <div class="col-md-1"  ></div>

                      <pre style=" height: 6pc; overflow-y: scroll;" class="col-md-5"   >
                      {{$des}}
                      </pre>
