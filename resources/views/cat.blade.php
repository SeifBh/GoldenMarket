...
<title>Gretong a Ecommerce Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
    ...
    <div class="header_top">
      ...
      <div class="top_right">
        <ul class="nav navbar-nav">
          ...
          <li ><a href="Admin/dashboard">{{  (Auth::check() && Auth::user()->isAdmin()) ? 'Tableau de board'  : '' }}</a></li>
      ...
      <div class="top_left">
        ...
        <h2><span></span> Contactez nous : {{$num}}</h2>
        ...
        <nav id="xx5" class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <li><a href="/">Acceuil</a></li>
                        ...
                        <li id="{{ ($name == $MenuList->name_cat ) ? 'satyalive' : '' }}"><a href="../../{{$MenuList->name_cat }}">{{$MenuList->name_cat }}</a></li>
                                      @endforeach
